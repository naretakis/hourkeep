...
- [x] Task 1: Create help text content structure

- [x] 1.1 Create `src/content/helpText.ts` file with TypeScript types
...
- [x] 1.2 Add work activity definitions to `helpText.ts`
...
- [x] 1.7 Add combination rules to `helpText.ts`
...
- [x] 1.8 Add dashboard guidance content to `helpText.ts`
  - Add 4 guidance steps (exemption, calendar, review, export)
  - Include icons and action links for each step
  - _Requirements: 4.1-4.6_

- [x] 1.9 Add "job searching doesn't count" to counter-examples
...
- [x] Task 2: Build HelpTooltip component

- [x] 2.1 Create `src/components/help/HelpTooltip.tsx` component
...
- [x] 2.2 Implement mobile bottom sheet for HelpTooltip
...
- [x] 2.3 Add content rendering to HelpTooltip
...
- [x] 2.4 Add keyboard accessibility to HelpTooltip
...
- [x] Task 3: Build HelpSection component (reuse exemption screener patterns)

- [x] 3.1 Review existing exemption screener expandable sections
...
- [x] 3.2 Create or extract `src/components/help/HelpSection.tsx` component
...
- [x] 3.3 Add content rendering to HelpSection
...
- [x] Task 4: Build EdgeCaseExamples component

- [x] 4.1 Create `src/components/help/EdgeCaseExamples.tsx` component
  - Create component with TypeScript props interface
  - Use HelpSection as wrapper (collapsed by default)
  - Map through edge case examples array
  - _Requirements: 5.1-5.2_

- [x] 4.2 Render edge case scenarios
...
- [x] 4.3 Style EdgeCaseExamples for mobile
...
- [x] Task 5: Build ActivityFormHelp component

- [x] 5.1 Create `src/components/activities/ActivityFormHelp.tsx` component
  - Create component with TypeScript props interface
  - Accept activityType prop (work, volunteer, education, workProgram)
  - Import activity definitions from helpText.ts
  - _Requirements: 1.1-1.2_

- [x] 5.2 Integrate HelpTooltip into ActivityFormHelp
...
- [x] 6.3 Render seasonal worker help
...
- [x] 6.5 Style income calculation display
...
- [x] Task 7: Build DashboardGuidance component

- [x] 7.1 Create `src/components/help/DashboardGuidance.tsx` component
  - Create component with TypeScript props interface
  - Import dashboard guidance from helpText.ts
  - Use MUI Card component
  - _Requirements: 4.1_

- [x] 7.2 Render guidance steps
...
- [x] 7.3 Add dismiss functionality
...
- [x] 7.6 Add DashboardGuidance to main dashboard
